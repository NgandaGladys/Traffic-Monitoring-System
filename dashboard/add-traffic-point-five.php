<div class="modal fade custom-modal" tabindex="-1" role="dialog" aria-labelledby="modal_add_user" aria-hidden="true" id="add-traffic-point-five">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="road_id" required>
                                    ...
                                    <?php $rad = $dbh->query("SELECT * FROM roads WHERE location = 'Bweyogerere Police Station'");
