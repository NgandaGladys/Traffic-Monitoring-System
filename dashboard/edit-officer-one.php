<div class="modal fade custom-modal" tabindex="-1" role="dialog" aria-labelledby="modal_add_user" aria-hidden="true" id="edit-officer-one<?=$rx->userid; ?>">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <!--`userid`, `fullname`, `phone`, `email`, `password`, `token`, `role`, `date_registered` -->
                    ...
                    <div class="modal-footer">
                        <button type="submit" name="update_officer_details_btn_one" class="btn btn-success">Save</button>
                    </div>
                </div>
            </form>
        </div>
