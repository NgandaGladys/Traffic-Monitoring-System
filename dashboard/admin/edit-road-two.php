<div class="modal fade custom-modal" tabindex="-1" role="dialog" aria-labelledby="modal_add_user" aria-hidden="true" id="edit-road-two<?=$rx->road_id;?>">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        <button type="submit" name="update_road_btn_two" class="btn btn-success">Save</button>
                    </div>
                </div>
            </form>
        </div>
