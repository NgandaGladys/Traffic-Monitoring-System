         ...
         <div class="row dashboard-header">
             <div class="card">
               <div class="card-header">
                  <h5 class="card-header-text">Admin <a href="#addadmin" class="btn btn-primary float-right" data-toggle="modal">Add admin</a></h5>
               </div>
                           ...
                           while($rx = $users->fetch(PDO::FETCH_OBJ)){ ?>
                              <tr>
                                 ...
                                 <td>
                                    ...
                                    <a onclick="return confirm('Do you really want to delete this admin?. '); " href="?delete-user=<?=$rx->userid; ?>" class="btn btn-danger">Delete</a>
                                 </td>
                              </tr>
   ...
   <div class="content-wrapper">
      ...
      <div class="container-fluid">
         ...
         <div class="row dashboard-header">
             <div class="card">
               <div class="card-header">
                  <h5 class="card-header-text">Officers <a href="#addofficer" class="btn btn-primary float-right" data-toggle="modal">Add Officer</a></h5>
               </div>
               <div class="card-block">
                  <div class="row">
                     <div class="col-sm-12 table-responsive">
         ...
         <div class="row dashboard-header">
            ...
            <div class="col-lg-3 col-md-6">
               <div class="card dashboard-product">
                  ...
                  <?php $admins = $dbh->query("SELECT * FROM users WHERE role = 'admin' ")->rowCount(); ?>
                  <h2 class="dashboard-total-products"><span><?=number_format($admins); ?></span></h2>
                  <span class="label label-warning"><a style="text-decoration: none; color: #FFF; " href="?officers">Admins</a></span>
                  <div class="side-box">
                     <i class="icon-user text-warning-color"></i>
                  </div>
               </div>
