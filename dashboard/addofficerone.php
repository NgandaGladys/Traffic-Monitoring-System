<div class="modal fade custom-modal" tabindex="-1" role="dialog" aria-labelledby="modal_add_user" aria-hidden="true" id="addofficerone">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        <button type="submit" name="add_new_officer_btn_one" class="btn btn-success">Save</button>
                    </div>
                </div>
            </form>
        </div>
